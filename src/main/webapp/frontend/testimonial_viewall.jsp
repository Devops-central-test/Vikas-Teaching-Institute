	...
	<div id="page">
		<jsp:include page="include/header.jsp"></jsp:include>
			 ...
			 <% 
                ...
                PreparedStatement ps=con.prepareStatement("select testmonial.content,testmonial.title,user_register.image from testmonial inner join user_register on testmonial.email=user_register.email where status='active' ");
							...
							<div class="one-fifth animate-box">
								...
								<div class="testimony-wrap">
									<blockquote>
										...
										<div class="figure-img" style="background-image: url(admin/images/<%=rs.getString("image")%>);"></div>
