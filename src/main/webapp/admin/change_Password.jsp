        ...
        String email=session.getAttribute("email1").toString();
                ...
                %>
                     ...
                     <% }else if(session.getAttribute("email2")!=null){
                      String email=session.getAttribute("email2").toString();
                      %>
                      <input type="hidden" name="email" value="<%=email%>">
                      <% } %>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" name="name" placeholder="Enter Current Password" required="required" type="text">
                      </div>
                    </div>
                   <div class="item form-group">
