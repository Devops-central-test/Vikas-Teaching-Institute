	...
	<div class="container body">
		<div class="main_container">
			...
			<div class="right_col" role="main">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard_graph">
							...
							<div class="row x_title">
								<div class="col-md-6">
                                                                    <h3>cars <small><a href="add_cars.jsp"><button class="btn-lg btn btn-outline btn-success">Add Cars</button></a></small></h3>
								</div>
								<div class="col-md-6">
              ...
              <div class="x_panel">
                <div class="x_title">
                  <h2>View Cars <small> Here </small></h2>
            ...
            String l2=null;
                Connection con=new connect_db().getConnection();
                   ...
                   while(rs.next())
                   {
                       l=rs.getString("economy");
                       l1=rs.getString("standard");
                       l2=rs.getString("luxury");
                   }
                           %>
                  <div class="row">
                    ...
                    <div class="col-md-55">
                      <div class="thumbnail">
                        ...
                        <div class="image view view-first">
                          <img style="width:150px;" src="images/<%=l%>" title="image">
                          <div class="mask">
                              <span>Economy</span>
                           </div>
                        </div>
                        <div class="image view view-first" >
                          <img style="width:150px;" src="images/<%=l1%>" title="image">
                          <div class="mask">
                              <span>Standard</span>
                           </div>
                        </div>
                          <div class="image view view-first">
                          <img style="width:150px;" src="images/<%=l2%>" title="image">
                          <div class="mask">
                              <span>Luxury</span>
                           </div>
                        </div>
