                 ...
                 <div class="x_content" style="display: flex;flex-wrap: wrap">
                  <br />
                   ...
                   <div class="col-md-4 col-sm-4 col-xs-12 animated fadeInDown">
                       <div class="well profile_view" style="height: 200px">
                        <div class="col-sm-12">
                         
                          <div class="left col-xs-7">
                            <h2><%=rs.getString("name")%></h2>
                            <p><strong>About: </strong><%=rs.getString("email")%> </p>
                            <ul class="list-unstyled">
                                <li><i class="fa fa-book"></i> Address:<strong><%=rs.getString("address")%></strong> </li>
                                <li><i class="fa fa-phone"></i> Mobile:<strong></strong><%=rs.getString("mobile")%> </li>

                            </ul>
                          </div>
                          <div class="right col-xs-5 text-center">
                            <img style="width:150px;" src="images/<%=rs.getString("image")%>" alt="" class="img-circle img-responsive">
                          </div>
                        </div>
