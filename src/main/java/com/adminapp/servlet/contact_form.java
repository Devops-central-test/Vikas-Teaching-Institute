 ...
 */
public class contact_form extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           String email1="";
              try{
                  ...
                  PreparedStatement ps1=con.prepareStatement("insert into contact_form(name,email,phone,message,subject) values(?,?,?,?,?)");
                      ...
                      String body="Hey!User<br>Greetings<br>Thankyou for contacting us.<br>Thankyou for your patience<br> We will contact you shortly<br> And resolve your query as soon as possible." ;
                       ...
                       String subject1="Regarding Query";
