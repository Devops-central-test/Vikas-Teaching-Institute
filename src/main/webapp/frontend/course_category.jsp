...
<!--		<div class="colorlib-classes">
		...
		<div class="colorlib-classes">
            ...
            PreparedStatement ps1=con1.prepareStatement("select * from courses where cid=? and status='active'");
            ps1.setString(1, id);
					...
					<div class="col-md-4 animate-box">
						<div class="classes">
							...
							<div class="wrap">
								...
								<div class="pricing">
                                                                    <p><span class="price">&#8377 <%=rs1.getString("price")%></span> </span> <button class="btn-cta" style="float: right"><a href="courses-single.jsp?id=<%=rs1.getString("id")%>"><span>Read More</span></a></button>
								</div>
							</div>
						</div>
					</div><% } %>
