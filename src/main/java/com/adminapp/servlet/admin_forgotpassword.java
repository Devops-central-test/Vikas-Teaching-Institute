...
public class admin_forgotpassword extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try
            {
                ...
                PreparedStatement ps= con.prepareStatement("select * from admin_profile where altemail=?");
                 ...
                 if(rs.next())
                {
                   ...
                   out.println("window.location.href='./admin/adminlogin.jsp'");
                   out.println("</script>");
                }
                else
                { out.println("<script type=\"text/javascript\">");
                  out.println("alert('Error! Email Not Registered')");
                  out.println("window.location.href='./admin/adminlogin.jsp'");
                  out.println("</script>");
                }
            }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(admin_forgotpassword.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
