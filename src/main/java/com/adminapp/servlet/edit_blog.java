...
@WebServlet(urlPatterns = {"/edit_blog"})
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          String title=request.getParameter("title");
           ...
           try{
               ...
               PreparedStatement ps=con.prepareStatement("update add_blog set title=?,image=?,content=? where id=? ");
...
out.println("window.location.href='./admin/view_blog.jsp'");
out.println("</script>");
                 }
               else
               {
...
out.println("</script>");
               ...
               PreparedStatement ps=con.prepareStatement("update add_blog set title=?,content=? where id=? ");
               ps.setString(1,title);
