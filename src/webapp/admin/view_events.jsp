                       ...
                       <td><%=organizer%></td>
                        <%
                                         ...
                                         if(session.getAttribute("email2")==null){
                                                           %>
                        <td><a href="edit_events.jsp?id=<%=id%>">  <button type="button" style="margin-left: 17px;" class="btn btn-success btn-xs">Edit</button></a>
                        <a href="../delete_events?id=<%=id%>" onclick="if(confirm('Sure Want?')){return true;} else{return false;};"><button type="button" style="margin-left: 10px;" class="btn btn-danger btn-xs">Delete</button></a>
                        </td>
                         <% } else{ %>
                          <td><a href="edit_events.jsp?id=<%=id%>">  <button type="button" style="margin-left: 17px;" class="btn btn-success btn-xs">Edit</button></a>
