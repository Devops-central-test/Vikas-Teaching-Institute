<%-- 
    Document   : refund_rules
    Created on : Dec 21, 2018, 9:33:55 AM
      ...
      <div class="right_col" role="main">
        <div class="">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2>Update Refund Policy<small>Here</small></h2>
            ...
            PreparedStatement ps=con.prepareStatement("select * from refund_policy");
            ResultSet rs=ps.executeQuery();
            while(rs.next()){
            %>
                  <form action ="../refund_policy" method="post" name="my_form" class="form-horizontal form-label-left" onSubmit="document.my_form.editor_contents.value = $('#editor').html()" >
                      <input type="hidden" name="id" value="<%=rs.getString("id")%>" 
                      <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="title">Page Name <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="title" pattern="([A-Za-z .])+" name="title" value="<%=rs.getString("name")%>"  title="Enter Words Only"   placeholder="Enter Title here" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div> 
