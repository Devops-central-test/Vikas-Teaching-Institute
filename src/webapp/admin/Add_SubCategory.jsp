...
<body class="nav-md">
	...
	<div class="container body">
        ...
        ResultSet rs=ps.executeQuery();
            ...
            %>
                  <form action ="../add_subcategory" id="demo-form2" method="post" data-parsley-validate class="form-horizontal form-label-left">
                     <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="title">Select Category <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="cid" class="form-control col-md-7 col-xs-12">
                              <% while(rs.next())
                            { %>
                             
                              <option value="<%=rs.getString("id")%>"><%=rs.getString("category")%></option>
                              <%}%>
                          </select>
                      </div>
                    </div>
