        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          String date=request.getParameter("date");
           ...
           try{
               ...
               PreparedStatement ps=con.prepareStatement("update events set heading=?,image=?,details=?,date=?,organizer=? where id=? ");
...
out.println("</script>");
               ...
               PreparedStatement ps=con.prepareStatement("update events set heading=?,details=?,date=?,organizer=? where id=? ");
               ps.setString(1,title);
