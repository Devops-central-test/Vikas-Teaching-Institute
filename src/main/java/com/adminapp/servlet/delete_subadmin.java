 ...
 */
public class delete_subadmin extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           String id=request.getParameter("id");
            ...
            try{
                ...
                PreparedStatement ps=con.prepareStatement("delete from add_subadmin where id=?");
                ps.setString(1, id);
                ps.executeUpdate();
