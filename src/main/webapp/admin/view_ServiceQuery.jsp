...
<head>
	...
	<title>view service query | </title>
                        ...
                        <div class="mail_heading row">
                          <div class="col-md-8">
                              ...
                              <div class="compose-btn">
                                  <% if(status.equals("not replied")){
                                      
                                  
              %>                    <a class="btn btn-sm btn-primary" href="ReplyserviceQuery.jsp?id=<%=id%>"><i class="fa fa-reply"></i> Reply</a>
