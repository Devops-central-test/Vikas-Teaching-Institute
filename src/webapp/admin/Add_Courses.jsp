...
<body class="nav-md">
      ...
      <div class="right_col" role="main">
        <div class="">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2>Add courses<small>Here</small></h2>
              ...
              <div class="x_content">
                  <form action ="../add_courses" method="post" name="my_form" class="form-horizontal form-label-left" enctype="Multipart/form-data" onSubmit="document.my_form.editor_contents.value = $('#editor').html()" >
                      <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Category">Main Category <span class="required"> *</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                         <select name='country' class="form-control col-md-7 col-xs-12"  onchange="showState(this.value)" >  
 ...
 while(rs.next()){
     ...
     %>
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="title">Course Name <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="title" pattern="([A-Za-z .])+" name="title" maxlength="100" title="Enter Words Only" required="required" placeholder="Enter Title here" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12"  for="file"> Image <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="price">Course Price <span class="required"> &#8377</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
      ...
      <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12"  for="descr">Add Description below: 
                           ...
                           <div class="col-md-6 col-sm-6 col-xs-12">
                               <textarea name="description" class="form-control col-md-7 col-xs-12" maxlength="1000"> </textarea>
                           </div>  </div>     
                <br />
                  <div class="form-group">
